  ...
  return (
    <>
      <motion.div whileHover={{ scale: 1.1 }} whileTap={{ scale: 0.9 }}>
        ...
        >
          <div className="flex flex-col min-w-[200px] w-[280px] sm:w-[330px] p-6 sm:p-8 gap-y-2 group">
            ...
            <div className="flex flex-col gap-y-2 items-start ">
              {others ? (
                <span className="flex items-center">
                  <p className="text-yellow-900 font-bold mr-1 text-sm sm:text-base">
                    {placement}
                  </p>
                  ...
                  <p className="text-yellow-900 font-light text-[10px] sm:text-xs mt-1">
                    {others}
                  </p>
                </span>
              ) : (
